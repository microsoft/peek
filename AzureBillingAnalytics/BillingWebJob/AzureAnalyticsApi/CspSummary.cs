...
{
    internal partial class CspSummary : IServiceOperations<AzureAnalyticsApi>, ICspSummary
    {
        /// <summary>
        ...
        /// </param>
        internal CspSummary(AzureAnalyticsApi client)
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<IList<UsageBasedLineItem>>> GetCSPSummaryDataWithOperationResponseAsync(
            CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "GetCSPSummaryDataAsync", tracingParameters);
            }

            // Construct URL
            string url = "";
            url = url + "/api/CspSummary";
            ...
            // Create Result
            HttpOperationResponse<IList<UsageBasedLineItem>> result =
            ...
            if (statusCode == HttpStatusCode.OK)
            {
                IList<UsageBasedLineItem> resultModel = new List<UsageBasedLineItem>();
                ...
                if (responseDoc != null)
                {
                    resultModel = UsageBasedLineItemCollection.DeserializeJson(responseDoc);
                }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<IList<UsageBasedLineItem>>>
            GetCurrentMonthDataWithOperationResponseAsync(
                CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
            bool shouldTrace = ServiceClientTracing.IsEnabled;
            ...
            // Construct URL
            string url = "";
            url = url + "/api/cspsummary/currentmonth";
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
            {
        ...
        /// </param>
        public async Task<HttpOperationResponse<IList<UsageBasedLineItem>>>
            GetDataForMonthRangeWithOperationResponseAsync(string startMMYYYY, string endMMYYYY,
                CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (startMMYYYY == null)
            ...
            // Construct URL
            string url = "";
            url = url + "/api/cspsummary/byMonthRange/";
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<IList<UsageBasedLineItem>>> GetSingleMonthDataWithOperationResponseAsync
            (string mmyyyy, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Construct URL
            string url = "";
            url = url + "/api/cspsummary/byMonth/";
