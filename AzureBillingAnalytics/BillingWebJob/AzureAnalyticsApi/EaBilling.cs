...
{
    internal partial class EaBilling : IServiceOperations<AzureAnalyticsApi>, IEaBilling
    {
        /// <summary>
        ...
        /// </param>
        internal EaBilling(AzureAnalyticsApi client)
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<IList<BillingDetailLineItem>>> GetAllDataWithOperationResponseAsync(
            CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Create Result
            HttpOperationResponse<IList<BillingDetailLineItem>> result =
                new HttpOperationResponse<IList<BillingDetailLineItem>>();
            ...
            if (statusCode == HttpStatusCode.OK)
            {
                IList<BillingDetailLineItem> resultModel = new List<BillingDetailLineItem>();
                ...
                if (responseDoc != null)
                {
                    resultModel = BillingDetailLineItemCollection.DeserializeJson(responseDoc);
                }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<IList<BillingDetailLineItem>>>
                ...
                CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Construct URL
            string url = "";
            url = url + "/api/eabilling/currentmonth";
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
            {
                ...
                CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // Construct URL
            string url = "";
            url = url + "/api/eabilling/byMonthRange/";
        ...
        /// </param>
        public async Task<HttpOperationResponse<IList<BillingDetailLineItem>>>
            GetSingleMonthDataWithOperationResponseAsync(string mMYYYY,
                CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (mMYYYY == null)
